    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            (
                ...
                "입력에 좋은 정보가 존재한다는 이유가 아니라 생성된 질문 문장 자체가 "
                "그 정보를 실제로 활용했는지를 평가하세요. "
                "Groundedness 5점은 질문의 경험·기술·역할이 입력 근거와 직접 연결되고, "
                "3점은 사실과 모순되지 않지만 일반적이며, 1점은 근거가 없거나 모순됩니다. "
                "입력에 없는 경험·기술·수치·역할을 사실처럼 전제하면 Groundedness는 "
                "최대 2점입니다. FOLLOW_UP은 직전 답변의 missing_points 중 한 가지를 "
                "정확히 확인해야 높은 Groundedness를 받을 수 있습니다. "
                "JD Relevance 5점은 질문 문장이 JD의 구체적인 업무·필수 역량과 직접 "
                "연결되고, 3점은 직무 일반론 수준이며, 1점은 직무와 무관합니다. "
